this.Element && function (e) {
    ...
    function () {
        for (var e = 0, t = ["webkit", "moz"], a = 0; a < t.length && !window.requestAnimationFrame; ++a)
...
var mUtil = function () {
    ...
    return {
        init: function (e) {
            e && e.breakpoints && (t = e.breakpoints),
                a()
        },
        ...
        getHighestZindex: function (e) {
            for (var t, a, n = mUtil.get(e); n && n !== document;) {
                if (("absolute" === (t = mUtil.css(n, "position")) || "relative" === t || "fixed" === t) && (a = parseInt(mUtil.css(n, "z-index")),
                    !isNaN(a) && 0 !== a))
                    return a;
                n = n.parentNode
            }
        ...
        hasFixedPositionedParent: function (e) {
            for (; e && e !== document;) {
                if (position = mUtil.css(e, "position"),
                    "fixed" === position)
                    return !0;
                e = e.parentNode
            }
        ...
        deepExtend: function (e) {
            ...
            for (var t = 1; t < arguments.length; t++) {
                ...
                if (a)
                    for (var n in a)
                        a.hasOwnProperty(n) && ("object" == typeof a[n] ? e[n] = mUtil.deepExtend(e[n], a[n]) : e[n] = a[n])
            }
            return e
        },
        extend: function (e) {
        ...
        hasClasses: function (e, t) {
            if (e) {
                for (var a = t.split(" "), n = 0; n < a.length; n++)
                    if (0 == mUtil.hasClass(e, mUtil.trim(a[n])))
                        return !1;
                return !0
            }
        },
            ...
            if (e && void 0 !== t) {
                ...
                if (e.classList)
                    for (var n = 0; n < a.length; n++)
                        a[n] && a[n].length > 0 && e.classList.add(mUtil.trim(a[n]));
                else if (!mUtil.hasClass(e, t))
                    for (n = 0; n < a.length; n++)
                        e.className += " " + mUtil.trim(a[n])
            }
        },
        removeClass: function (e, t) {
            if (e) {
                ...
                if (e.classList)
                    for (var n = 0; n < a.length; n++)
                        e.classList.remove(mUtil.trim(a[n]));
                else if (mUtil.hasClass(e, t))
                    for (n = 0; n < a.length; n++)
                        e.className = e.className.replace(new RegExp("\\b" + mUtil.trim(a[n]) + "\\b", "g"), "")
            }
        },
        triggerCustomEvent: function (e, t, a) {
            if (window.CustomEvent)
                ...
                (n = document.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, a);
            e.dispatchEvent(n)
        },
        trim: function (e) {
            return e.trim()
        ...
        parents: function (e, t) {
            ...
            return function (e, t) {
                for (var n = document.querySelectorAll(t), o = e.parentNode; o && !a(n, o);)
                    o = o.parentNode;
                return o
            }(e, t)
        },
        children: function (e, t, a) {
            if (e && e.childNodes) {
                for (var n = [], o = 0, i = e.childNodes.length; o < i; ++o)
                    1 == e.childNodes[o].nodeType && mUtil.matches(e.childNodes[o], t, a) && n.push(e.childNodes[o]);
                return n
            }
        },
        ...
        data: function (e) {
            return e = mUtil.get(e),
                {
                    set: function (t, a) {
                        void 0 === e.customDataTag && (mUtilElementDataStoreID++ ,
                            e.customDataTag = mUtilElementDataStoreID),
                            void 0 === mUtilElementDataStore[e.customDataTag] && (mUtilElementDataStore[e.customDataTag] = {}),
                            mUtilElementDataStore[e.customDataTag][t] = a
                    },
                    get: function (t) {
        ...
        outerWidth: function (e, t) {
            if (!0 === t) {
                ...
                return a += parseFloat(mUtil.css(e, "margin-left")) + parseFloat(mUtil.css(e, "margin-right")),
                    parseFloat(a)
            }
        ...
        attr: function (e, t, a) {
            if (void 0 != (e = mUtil.get(e)))
                return void 0 === a ? e.getAttribute(t) : void e.setAttribute(t, a)
        },
        ...
        animate: function (e, t, a, n, o, i) {
            ...
            if ("number" == typeof e && "number" == typeof t && "number" == typeof a && "function" == typeof n) {
                "string" == typeof o && l[o] && (o = l[o]),
                    "function" != typeof o && (o = l.linear),
        ...
        actualCss: function (e, t, a) {
            ...
            if (e instanceof HTMLElement != !1)
                return e.getAttribute("m-hidden-" + t) && !1 !== a ? parseFloat(e.getAttribute("m-hidden-" + t)) : (e.style.cssText = "position: absolute; visibility: hidden; display: block;",
                    "width" == t ? n = e.offsetWidth : "height" == t && (n = e.offsetHeight),
                    e.style.cssText = "",
                    e.setAttribute("m-hidden-" + t, n),
                    parseFloat(n))
        },
                ...
                if (void 0 !== a)
                    ...
                    if (e.currentStyle)
                        return t = t.replace(/\-(\w)/g, function (e, t) {
                            ...
                            a = e.currentStyle[t],
                            /^\d+(em|pt|%|ex)?$/i.test(a) ? function (t) {
                                var a = e.style.left
        ...
        slide: function (e, t, a, n, o) {
            if (!(!e || "up" == t && !1 === mUtil.visible(e) || "down" == t && !0 === mUtil.visible(e))) {
                ...
                var i = mUtil.actualHeight(e)
                    , l = !1
                    , r = !1;
                mUtil.css(e, "padding-top") && !0 !== mUtil.data(e).has("slide-padding-top") && mUtil.data(e).set("slide-padding-top", mUtil.css(e, "padding-top")),
                    mUtil.css(e, "padding-bottom") && !0 !== mUtil.data(e).has("slide-padding-bottom") && mUtil.data(e).set("slide-padding-bottom", mUtil.css(e, "padding-bottom")),
                    ...
                    "up" == t ? (e.style.cssText = "display: block; overflow: hidden;",
                        l && mUtil.animate(0, l, a, function (t) {
        ...
        on: function (e, t, a, n) {
            if (t) {
                ...
                return mUtilDelegatedEventHandlers[o] = function (a) {
                    ...
                    ,
                    mUtil.addEvent(e, a, mUtilDelegatedEventHandlers[o]),
                    o
            }
        },
        off: function (e, t, a) {
            e && mUtilDelegatedEventHandlers[a] && (mUtil.removeEvent(e, t, mUtilDelegatedEventHandlers[a]),
        ...
        animateClass: function (e, t, a) {
            mUtil.addClass(e, "animated " + t),
                mUtil.one(e, "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
        ...
        animateDelay: function (e, t) {
            for (var a = ["webkit-", "moz-", "ms-", "o-", ""], n = 0; n < a.length; n++)
                mUtil.css(e, a[n] + "animation-delay", t)
        },
        animateDuration: function (e, t) {
            for (var a = ["webkit-", "moz-", "ms-", "o-", ""], n = 0; n < a.length; n++)
                mUtil.css(e, a[n] + "animation-duration", t)
        },
        ...
        scrollToViewport: function (e, t) {
            t || (t = 1200),
                zenscroll.intoView(e, t)
        },
        scrollToCenter: function (e, t) {
            t || (t = 1200),
                zenscroll.center(e, t)
        },
        ...
        numberString: function (e) {
            for (var t = (e += "").split("."), a = t[0], n = t.length > 1 ? "." + t[1] : "", o = /(\d+)(\d{3})/; o.test(a);)
                a = a.replace(o, "$1,$2");
            return a + n
        }
    }
...
var mApp = function () {
    var e = {
        ...
        , l = function () {
            $('[m-portlet="true"]').each(function () {
                var e = $(this);
                !0 !== e.data("portlet-initialized") && (i(e, {}),
            ...
            $("[data-tab-target]").each(function () {
                1 != $(this).data("tabs-initialized") && ($(this).click(function (e) {
                    ...
                    a.find(".m-tabs__item.m-tabs__item--active").removeClass("m-tabs__item--active"),
                        t.addClass("m-tabs__item--active"),
    ...
    return {
        ...
        initComponents: function () {
            jQuery.event.special.touchstart = {
                ...
                $('[data-scrollable="true"]').each(function () {
                    var e, t, a = $(this);
                    mUtil.isInResponsiveRange("tablet-and-mobile") ? (e = a.data("mobile-max-height") ? a.data("mobile-max-height") : a.data("max-height"),
                        t = a.data("mobile-height") ? a.data("mobile-height") : a.data("height")) : (e = a.data("max-height"),
                            t = a.data("max-height")),
                        e && a.css("max-height", e),
                        t && a.css("height", t),
                        mApp.initScroller(a, {})
                }),
                a(),
        ...
        initScroller: function (e, t, a) {
            mUtil.isMobileDevice() ? e.css("overflow", "auto") : (!0 !== a && mApp.destroyScroller(e),
                e.mCustomScrollbar({
                    scrollInertia: 0,
                    autoDraggerLength: !0,
                    autoHideScrollbar: !0,
        ...
        block: function (e, t) {
            ...
            if ("spinner" == (t = $.extend(!0, {
                ...
                shadow: !0,
                width: "auto"
            }, t)).type ? o = '<div class="m-spinner ' + (a = t.skin ? "m-spinner--skin-" + t.skin : "") + " " + (n = t.state ? "m-spinner--" + t.state : "") + '"></div' : (a = t.skin ? "m-loader--skin-" + t.skin : "",
                n = t.state ? "m-loader--" + t.state : "",
                size = t.size ? "m-loader--" + t.size : "",
                o = '<div class="m-loader ' + a + " " + n + " " + size + '"></div'),
                t.message && t.message.length > 0) {
                ...
                mUtil.get("body").prepend(i),
                    mUtil.addClass(i, l),
                    i.innerHTML = "<span>" + t.message + "</span><span>" + o + "</span>",
                    t.width = mUtil.actualWidth(i) + 10,
                    mUtil.remove(i),
                    "body" == e && (html = '<div class="' + l + '" style="margin-left:-' + t.width / 2 + 'px;"><span>' + t.message + "</span><span>" + o + "</span></div>")
            } else
                html = o;
            var r = {
                message: html,
                ...
                onUnblock: function () {
                    i && (mUtil.css(i, "position", ""),
                        mUtil.css(i, "zoom", ""))
                }
            };
            "body" == e ? (r.css.top = "50%",
                $.blockUI(r)) : (i = $(e)).block(r)
        },
        unblock: function (e) {
        ...
        e.fn.mDatatable = function (t) {
            if (0 !== e(this).length) {
                ...
                var n = {
                    ...
                    init: function (t) {
                        var o = !1;
                        return null === t.data.source && (n.extractTable(),
                            o = !0),
                            n.setupBaseDOM.call(),
                            n.setupDOM(a.table),
                            n.spinnerCallback(!0),
                            n.setDataSourceQuery(n.getOption("data.source.read.params.query")),
                            e(a).on("m-datatable--on-layout-updated", n.afterRender),
                            a.debug && n.stateRemove(n.stateId),
                            e.each(n.getOption("extensions"), function (t, n) {
                                "function" == typeof e.fn.mDatatable[t] && new e.fn.mDatatable[t](a, n)
                            }),
                            "remote" !== t.data.type && "local" !== t.data.type || ((!1 === t.data.saveState || !1 === t.data.saveState.cookie && !1 === t.data.saveState.webstorage) && n.stateRemove(n.stateId),
                                "local" === t.data.type && "object" == typeof t.data.source && (a.dataSet = a.originalDataSet = n.dataMapCallback(t.data.source)),
                                n.dataRender()),
                            o || (n.setHeadTitle(),
                                n.getOption("layout.footer") && n.setHeadTitle(a.tableFoot)),
                            void 0 !== t.layout.header && !1 === t.layout.header && e(a.table).find("thead").remove(),
                            void 0 !== t.layout.footer && !1 === t.layout.footer && e(a.table).find("tfoot").remove(),
                            null !== t.data.type && "local" !== t.data.type || (n.setupCellField.call(),
                                n.setupTemplateCell.call(),
                                n.setupSubDatatable.call(),
                                n.setupSystemColumn.call(),
                                n.redraw()),
                            e(window).resize(n.fullRender),
                            e(a).height(""),
                            e(n.getOption("search.input")).on("keyup", function (t) {
                    ...
                    extractTable: function () {
                        var n = []
                            , o = e(a).find("tr:first-child th").get().map(function (a, o) {
                                ...
                                for (var r in t.columns)
                                    t.columns[r].field === i && (l = e.extend(!0, {}, t.columns[r], l));
                                return n.push(l),
                                    i
                            });
                        t.columns = n;
                    ...
                    layoutUpdate: function () {
                        n.setupSubDatatable.call(),
                            n.setupSystemColumn.call(),
                            n.setupHover.call(),
                            void 0 === t.detail && 1 === n.getDepth() && n.lockTable.call(),
                            n.columnHide.call(),
                            n.resetScroll(),
                            n.isInit || (e(a).trigger("m-datatable--on-init", {
                                table: e(a.wrap).attr("id"),
                                options: t
                            }),
                                n.isInit = !0),
                            e(a).trigger("m-datatable--on-layout-updated", {
                                table: e(a.wrap).attr("id")
                            })
                    },
                    lockTable: function () {
                        var t = {
                            lockEnabled: !1,
                            init: function () {
                                t.lockEnabled = n.lockEnabledColumns(),
                                    0 === t.lockEnabled.left.length && 0 === t.lockEnabled.right.length || t.enable()
                            },
                            enable: function () {
                                e(a.table).find("thead,tbody,tfoot").each(function () {
                                    ...
                                    0 === e(this).find(".m-datatable__lock").length && e(this).ready(function () {
                                        !function (o) {
                                            if (e(o).find(".m-datatable__lock").length > 0)
                                                ...
                                                e(o).find(".m-datatable__row").each(function () {
                                                    ...
                                                    e(this).find(".m-datatable__cell").each(function () {
                                                        ...
                                                        void 0 !== o ? (void 0 === o.left && !0 !== o || e(this).appendTo(t),
                                                            void 0 !== o.right && e(this).appendTo(n)) : e(this).appendTo(a)
                                                    }),
                                                        e(this).remove()
                                                }),
                                                    t.lockEnabled.left.length > 0 && (e(a.wrap).addClass("m-datatable--lock"),
                                                        e(i).appendTo(o)),
                                                    (t.lockEnabled.left.length > 0 || t.lockEnabled.right.length > 0) && e(l).appendTo(o),
                                                    t.lockEnabled.right.length > 0 && (e(a.wrap).addClass("m-datatable--lock"),
                                                        e(r).appendTo(o))
                                            } else
                                                n.log("No row exist in: ", o)
                                        }(o)
                                    })
                                })
                            }
                    ...
                    fullRender: function () {
                        n.spinnerCallback(!0),
                            e(a.wrap).removeClass("m-datatable--loaded"),
                            n.insertData()
                    },
                    lockEnabledColumns: function () {
                        ...
                        return e.each(n, function (e, t) {
                            void 0 !== t.locked && (void 0 !== t.locked.left && mUtil.getBreakpoint(t.locked.left) <= a && o.left.push(t.locked.left),
                                void 0 !== t.locked.right && mUtil.getBreakpoint(t.locked.right) <= a && o.right.push(t.locked.right))
                        }),
                            o
                    },
                    afterRender: function (t, o) {
                        o.table == e(a.wrap).attr("id") && e(a).ready(function () {
                            n.isLocked() || (n.redraw(),
                                n.getOption("rows.autoHide") && (n.autoHide(),
                                    e(a.table).find(".m-datatable__row").css("height", ""))),
                                e(a.tableBody).find(".m-datatable__row").removeClass("m-datatable__row--even"),
                                e(a.wrap).hasClass("m-datatable--subtable") ? e(a.tableBody).find(".m-datatable__row:not(.m-datatable__row-detail):even").addClass("m-datatable__row--even") : e(a.tableBody).find(".m-datatable__row:nth-child(even)").addClass("m-datatable__row--even"),
                                n.isLocked() && n.redraw(),
                                e(a.tableBody).css("visibility", ""),
                                e(a.wrap).addClass("m-datatable--loaded"),
                                n.scrollbar.call(),
                                n.sorting.call(),
                                n.spinnerCallback(!1)
                        })
                    ...
                    adjustLockContainer: function () {
                        ...
                        return e(a.table).find(".m-datatable__lock--scroll").css("width", l),
                            l
                    },
                    dragResize: function () {
                        ...
                        e(a.tableHead).find(".m-datatable__cell").mousedown(function (a) {
                            i = e(this),
                                ...
                                t = a.pageX,
                                n = e(this).width(),
                                e(i).addClass("m-datatable__cell--resizing")
                            ...
                            e(i).removeClass("m-datatable__cell--resizing"),
                                o = !1
                        }),
                    ...
                    initHeight: function () {
                        if (t.layout.height && t.layout.scroll) {
                            ...
                            n > 0 && (i -= n),
                                o > 0 && (i -= o),
                                e(a.tableBody).css("max-height", i)
                        }
                    },
                    setupBaseDOM: function () {
                        a.initialDatatable = e(a).clone(),
                            "TABLE" === e(a).prop("tagName") ? (a.table = e(a).removeClass("m-datatable").addClass("m-datatable__table"),
                                0 === e(a.table).parents(".m-datatable").length && (a.table.wrap(e("<div/>").addClass("m-datatable").addClass("m-datatable--" + t.layout.theme)),
                                    a.wrap = e(a.table).parent())) : (a.wrap = e(a).addClass("m-datatable").addClass("m-datatable--" + t.layout.theme),
                                        a.table = e("<table/>").addClass("m-datatable__table").appendTo(a)),
                            void 0 !== t.layout.class && e(a.wrap).addClass(t.layout.class),
                            e(a.table).removeClass("m-datatable--destroyed").css("display", "block"),
                            void 0 === e(a).attr("id") && (n.setOption("data.saveState", !1),
                                e(a.table).attr("id", mUtil.getUniqueID("m-datatable--"))),
                            n.getOption("layout.minHeight") && e(a.table).css("min-height", n.getOption("layout.minHeight")),
                            n.getOption("layout.height") && e(a.table).css("max-height", n.getOption("layout.height")),
                            null === t.data.type && e(a.table).css("width", "").css("display", ""),
                            a.tableHead = e(a.table).find("thead"),
                            0 === e(a.tableHead).length && (a.tableHead = e("<thead/>").prependTo(a.table)),
                            a.tableBody = e(a.table).find("tbody"),
                            0 === e(a.tableBody).length && (a.tableBody = e("<tbody/>").appendTo(a.table)),
                            void 0 !== t.layout.footer && t.layout.footer && (a.tableFoot = e(a.table).find("tfoot"),
                                0 === e(a.tableFoot).length && (a.tableFoot = e("<tfoot/>").appendTo(a.table)))
                    },
                            ...
                            "function" == typeof s && s(e(o), l, t),
                                ...
                                e(o).find(".m-datatable__cell").each(function (o, r) {
                                    ...
                                    if (void 0 !== s && void 0 !== s.template) {
                                        var d = "";
                                        "string" == typeof s.template && (d = n.dataPlaceholder(s.template, l)),
                                            "function" == typeof s.template && (d = s.template(l, t, a));
                                        var c = document.createElement("span");
                                        c.innerHTML = d,
                                            e(r).html(c),
                                            void 0 !== s.overflow && (e(c).css("overflow", s.overflow),
                                                e(c).css("position", "relative"))
                                    }
                                });
                        ...
                        if (a.dataSet = a.dataSet || [],
                                ...
                                e(a).find(".m-datatable__cell").each(function (t, a) {
                                    ...
                                    if (void 0 !== i) {
                                        ...
                                        if (void 0 !== i.selector && !1 !== i.selector) {
                                            if (e(a).find('.m-checkbox [type="checkbox"]').length > 0)
                                                return;
                                            ...
                                            void 0 !== i.selector.class && e(r).addClass(i.selector.class),
                                                e(a).children().html(r)
                                        }
                                        if (void 0 !== i.subtable && i.subtable) {
                                            if (e(a).find(".m-datatable__toggle-subtable").length > 0)
                                                return;
                            ...
                            var i = function (t) {
                                ...
                                if (void 0 !== a && void 0 !== a.selector && !1 !== a.selector) {
                                    ...
                                    if (e(i).find('.m-checkbox [type="checkbox"]').length > 0)
                                        return;
                                    ...
                                    void 0 !== a.selector.class && e(l).addClass(a.selector.class),
                                        e(i).children().html(l)
                                }
                            };
                            t.layout.header && i(e(a.tableHead).find(".m-datatable__row").first()),
                                t.layout.footer && i(e(a.tableFoot).find(".m-datatable__row").first())
                        }
                    },
                    adjustCellsWidth: function () {
                        ...
                        if (o > 0) {
                            ...
                            i <= n.offset && (i = n.offset),
                                e(a.table).find(".m-datatable__row").find(".m-datatable__cell:visible").each(function (t, a) {
                                    var n = i
                                        , o = e(a).data("width");
                                    void 0 !== o && (n = o),
                                        e(a).children().css("width", parseInt(n))
                                })
                        }
                        return a
                    },
                        ...
                        var o = {
                            ...
                            init: function () {
                                ...
                                if (t.layout.scroll) {
                                    ...
                                    e(l).find(".m-datatable__row").length > 0 && e(l).length > 0 ? (o.scrollHead = e(a.tableHead).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                        o.scrollFoot = e(a.tableFoot).find("> .m-datatable__lock--scroll > .m-datatable__row"),
                                        o.tableLocked = e(a.tableBody).find(".m-datatable__lock:not(.m-datatable__lock--scroll)"),
                                        i > mUtil.getBreakpoint("lg") ? o.mCustomScrollbar(l) : o.defaultScrollbar(l)) : e(a.tableBody).find(".m-datatable__row").length > 0 && (o.scrollHead = e(a.tableHead).find("> .m-datatable__row"),
                                            o.scrollFoot = e(a.tableFoot).find("> .m-datatable__row"),
                                            i > mUtil.getBreakpoint("lg") ? o.mCustomScrollbar(a.tableBody) : o.defaultScrollbar(a.tableBody))
                                } else
                                    e(a.table).css("overflow-x", "auto")
                            },
                            ...
                            onScrolling: function (t) {
                                var a = e(this).scrollLeft()
                                    , n = e(this).scrollTop();
                                e(o.scrollHead).css("left", -a),
                                    e(o.scrollFoot).css("left", -a),
                                    e(o.tableLocked).each(function (t, a) {
                                        e(a).css("top", -n)
                                    })
                            },
                            mCustomScrollbar: function (t) {
                                ...
                                var l = e.extend({}, o.mcsOptions, {
                                    ...
                                    callbacks: {
                                        whileScrolling: function () {
                                            var t = this.mcs;
                                            e(o.scrollHead).css("left", t.left),
                                                e(o.scrollFoot).css("left", t.left),
                                                e(o.tableLocked).each(function (a, n) {
                                                    e(n).css("top", t.top)
                                                }),
                                                clearTimeout(n.hoverTimer),
                                                n.isScrolling = !0
                                ...
                                !0 === n.getOption("layout.smoothScroll.scrollbarShown") && e(t).attr("data-scrollbar-shown", "true"),
                                    n.mCustomScrollbar(t, l)
                            }
                        };
                        return o.init(),
                            o
                    ...
                    setHeadTitle: function (o) {
                        ...
                        void 0 === l && (l = document.createElement("tr"),
                            o.appendChild(l)),
                            e.each(i, function (t, n) {
                                var o = r[t];
                                if (void 0 === o && (o = document.createElement("th"),
                                    l.appendChild(o)),
                                    void 0 !== n.title && (o.innerHTML = n.title,
                                        o.setAttribute("data-field", n.field),
                                        mUtil.addClass(o, n.class),
                                        e(o).data(n)),
                                    void 0 !== n.attr && e.each(n.attr, function (e, t) {
                                        o.setAttribute(e, t)
                                    }),
                                    void 0 !== n.textAlign) {
                    ...
                    dataRender: function (o) {
                        ...
                        var i = function () {
                            ...
                            0 === o.perpage && (o.perpage = t.data.pageSize || 10),
                                o.total = a.dataSet.length;
                            var i = Math.max(o.perpage * (o.page - 1), 0)
                                , l = Math.min(i + o.perpage, o.total);
                            return a.dataSet = e(a.dataSet).slice(i, l),
                                o
                        }
                            , l = function (o) {
                                var l = function (t, o) {
                                    e(t.pager).hasClass("m-datatable--paging-loaded") || (e(t.pager).remove(),
                                        t.init(o)),
                                        e(t.pager).off().on("m-datatable--on-goto-page", function (a) {
                                            e(t.pager).remove(),
                                                t.init(o)
                                        });
                                    var i = Math.max(o.perpage * (o.page - 1), 0)
                                        , l = Math.min(i + o.perpage, o.total);
                                    n.localDataUpdate(),
                                        a.dataSet = e(a.dataSet).slice(i, l),
                                        n.insertData()
                                };
                                if (e(a.wrap).removeClass("m-datatable--error"),
                                    t.pagination)
                    ...
                    insertData: function () {
                        ...
                        if (e.each(a.dataSet, function (i, l) {
                            ...
                            r.setAttribute("data-row", i),
                                e(r).data("obj", l),
                                void 0 !== s[i] && e.each(s[i], function () {
                                    r.setAttribute(this.name, this.value)
                                });
                            for (var m = 0; m < c; m += 1) {
                                var u = t.columns[m]
                                    , p = [];
                                if (n.getObject("sort.field", o) === u.field && p.push("m-datatable__cell--sorted"),
                                    void 0 !== u.textAlign) {
                            ...
                            mUtil.addClass(m, "m-datatable--error"),
                                ...
                                d.appendChild(m),
                                e(a.wrap).addClass("m-datatable--error m-datatable--loaded"),
                                n.spinnerCallback(!1)
                        }
                        e(a.tableBody).replaceWith(d),
                            a.tableBody = d,
                            n.setupDOM(a.table),
                    ...
                    updateTableComponents: function () {
                        a.tableHead = e(a.table).children("thead"),
                            a.tableBody = e(a.table).children("tbody"),
                            a.tableFoot = e(a.table).children("tfoot")
                    },
                    getData: function () {
                        n.spinnerCallback(!0);
                        var o = {
                        ...
                        if ("local" === t.data.type && (o.url = t.data.source),
                            "remote" === t.data.type) {
                            o.url = n.getOption("data.source.read.url"),
                                "string" != typeof o.url && (o.url = n.getOption("data.source.read")),
                                "string" != typeof o.url && (o.url = n.getOption("data.source")),
                            ...
                            n.getOption("data.serverPaging") || delete i.pagination,
                                ...
                                o.data = e.extend(!0, o.data, i, n.getOption("data.source.read.params"))
                        }
                        return e.ajax(o).done(function (t, o, i) {
                            a.lastResponse = t,
                                a.dataSet = a.originalDataSet = n.dataMapCallback(t),
                                n.setAutoColumns(),
                                e(a).trigger("m-datatable--on-ajax-done", [a.dataSet])
                        }).fail(function (t, o, i) {
                            n.destroyScroller(e(a.table).find(".mCustomScrollbar")),
                                e(a).trigger("m-datatable--on-ajax-fail", [t]),
                                e(a.tableBody).html(e("<span/>").addClass("m-datatable--error").html(n.getOption("translate.records.noRecords"))),
                                e(a.wrap).addClass("m-datatable--error m-datatable--loaded"),
                                n.spinnerCallback(!1)
                        }).always(function () { })
                    },
                        ...
                        var i = {
                            ...
                            init: function (t) {
                                i.meta = t,
                                    ...
                                    i.pager = e(a.table).siblings(".m-datatable__pager"),
                                    e(i.pager).hasClass("m-datatable--paging-loaded") || (e(i.pager).remove(),
                                        0 !== i.meta.pages && (n.setDataSourceParam("pagination", {
                                            page: i.meta.page,
                                            pages: i.meta.pages,
                                            ...
                                            e(a).trigger(i.paginateEvent, i.meta),
                                            i.pagingBreakpoint.call(),
                                            e(window).resize(i.pagingBreakpoint)))
                            },
                            ...
                            populate: function () {
                                ...
                                i.pagerLayout.pagination = l,
                                    e("<li/>").append(e("<a/>").attr("title", o.first).addClass("m-datatable__pager-link m-datatable__pager-link--first").append(e("<i/>").addClass(t.first)).on("click", i.gotoMorePage).attr("data-page", 1)).appendTo(l),
                                    e("<li/>").append(e("<a/>").attr("title", o.prev).addClass("m-datatable__pager-link m-datatable__pager-link--prev").append(e("<i/>").addClass(t.prev)).on("click", i.gotoMorePage)).appendTo(l),
                                    e("<li/>").append(e("<a/>").attr("title", o.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-prev").html(e("<i/>").addClass(t.more)).on("click", i.gotoMorePage)).appendTo(l),
                                    e("<li/>").append(e("<input/>").attr("type", "text").addClass("m-pager-input form-control").attr("title", o.input).on("keyup", function () {
                                ...
                                e("<li/>").append(e("<a/>").attr("title", o.more).addClass("m-datatable__pager-link m-datatable__pager-link--more-next").html(e("<i/>").addClass(t.more)).on("click", i.gotoMorePage)).appendTo(l),
                                    e("<li/>").append(e("<a/>").attr("title", o.next).addClass("m-datatable__pager-link m-datatable__pager-link--next").append(e("<i/>").addClass(t.next)).on("click", i.gotoMorePage)).appendTo(l),
                                    e("<li/>").append(e("<a/>").attr("title", o.last).addClass("m-datatable__pager-link m-datatable__pager-link--last").append(e("<i/>").addClass(t.last)).on("click", i.gotoMorePage).attr("data-page", i.meta.pages)).appendTo(l),
                                    n.getOption("toolbar.items.info") && (i.pagerLayout.info = e("<div/>").addClass("m-datatable__pager-info").append(e("<span/>").addClass("m-datatable__pager-detail"))),
                                    e.each(n.getOption("toolbar.layout"), function (t, a) {
                                ...
                                0 == p.length && (p = [10, 20, 30, 50, 100]),
                                    e.each(p, function (t, a) {
                                        var n = a;
                                        -1 === a && (n = "All"),
                                            e("<option/>").attr("value", a).html(n).appendTo(u)
                                    }),
                                    e(a).ready(function () {
                            ...
                            paste: function () {
                                e.each(e.unique(n.getOption("toolbar.placement")), function (t, n) {
                                    "bottom" === n && e(i.pager).clone(!0).insertAfter(a.table),
                                        "top" === n && e(i.pager).clone(!0).addClass("m-datatable__pager--top").insertBefore(a.table)
                                })
                            },
                            gotoMorePage: function (t) {
                                ...
                                return void 0 === a && (a = e(t.target).attr("data-page")),
                                    i.openPage(parseInt(a)),
                                    !1
                            },
                            gotoPage: function (t) {
                                t.preventDefault(),
                                    e(this).hasClass("m-datatable__pager-link--active") || i.openPage(parseInt(e(this).data("page")))
                            },
                            openPage: function (t) {
                                i.meta.page = parseInt(t),
                                    e(a).trigger(i.paginateEvent, i.meta),
                                    i.callback(i, i.meta),
                                    e(i.pager).trigger("m-datatable--on-goto-page", i.meta)
                            },
                            updatePerpage: function (t) {
                                t.preventDefault(),
                                    null === n.getOption("layout.height") && e("html, body").animate({
                                        scrollTop: e(a).position().top
                                    }),
                                    i.pager = e(a.table).siblings(".m-datatable__pager").removeClass("m-datatable--paging-loaded"),
                                    t.originalEvent && (i.meta.perpage = parseInt(e(this).val())),
                                    e(i.pager).find("select.m-datatable__pager-size").val(i.meta.perpage).attr("data-selected", i.meta.perpage),
                                    ...
                                    e(i.pager).trigger("m-datatable--on-update-perpage", i.meta),
                                    e(a).trigger(i.paginateEvent, i.meta),
                                    i.callback(i, i.meta),
                                    i.updateInfo.call()
                            },
                            addPaginateEvent: function (t) {
                                e(a).off(i.paginateEvent).on(i.paginateEvent, function (t, o) {
                                    ...
                                    e(l).find(".m-datatable__pager-link--active").removeClass("m-datatable__pager-link--active"),
                                        e(l).find('.m-datatable__pager-link-number[data-page="' + o.page + '"]').addClass("m-datatable__pager-link--active"),
                                        e(l).find(".m-datatable__pager-link--prev").attr("data-page", Math.max(o.page - 1, 1)),
                                        e(l).find(".m-datatable__pager-link--next").attr("data-page", Math.min(o.page + 1, o.pages)),
                                        e(i.pager).each(function () {
                                            e(this).find('.m-pager-input[type="text"]').prop("value", o.page)
                                        }),
                                        e(i.pager).find(".m-datatable__pager-nav").show(),
                                        o.pages <= 1 && e(i.pager).find(".m-datatable__pager-nav").hide(),
                                        n.setDataSourceParam("pagination", {
                                            page: i.meta.page,
                                            pages: i.meta.pages,
                                            perpage: i.meta.perpage,
                                        ...
                                        e(i.pager).find("select.m-datatable__pager-size").val(o.perpage).attr("data-selected", o.perpage),
                                        e(a.table).find('.m-checkbox > [type="checkbox"]').prop("checked", !1),
                                        e(a.table).find(".m-datatable__row--active").removeClass("m-datatable__row--active"),
                                        i.updateInfo.call(),
                                        i.pagingBreakpoint.call()
                                })
                            },
                            ...
                            pagingBreakpoint: function () {
                                ...
                                if (0 !== e(t).length) {
                                    ...
                                    e(t).find("li").show(),
                                        e.each(n.getOption("toolbar.items.pagination.pages"), function (a, r) {
                                            if (mUtil.isInResponsiveRange(a)) {
                                                switch (a) {
                                                    ...
                                                    case "mobile":
                                                        e(l).show(),
                                                            e(t).find(".m-datatable__pager-link--more-prev").closest("li").hide(),
                            ...
                            paginationUpdate: function () {
                                ...
                                e(l).each(function (t, a) {
                                    ...
                                    p === i.meta.pages && p === e(m).last().data("page") ? e(l).parent().hide() : e(l).parent().show(),
                                    1 === i.meta.page ? (e(r).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                                        e(s).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (e(r).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"),
                                            e(s).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled")),
                                    i.meta.page === i.meta.pages ? (e(d).attr("disabled", !0).addClass("m-datatable__pager-link--disabled"),
                                        e(c).attr("disabled", !0).addClass("m-datatable__pager-link--disabled")) : (e(d).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"),
                                            e(c).removeAttr("disabled").removeClass("m-datatable__pager-link--disabled"));
                    ...
                    columnHide: function () {
                        ...
                        e.each(t.columns, function (t, o) {
                            if (void 0 !== o.responsive) {
                                ...
                                mUtil.getBreakpoint(o.responsive.hidden) >= n ? e(l).hide() : e(l).show(),
                                    mUtil.getBreakpoint(o.responsive.visible) <= n ? e(l).show() : e(l).hide()
                            }
                        })
                    },
                    setupSubDatatable: function () {
                        ...
                        if ("function" == typeof o && !(e(a.table).find(".m-datatable__subtable").length > 0)) {
                            e(a.wrap).addClass("m-datatable--subtable"),
                                t.columns[0].subtable = !0;
                            var i = function (i) {
                                i.preventDefault();
                                var l = e(this).closest(".m-datatable__row")
                                    , r = e(l).next(".m-datatable__row-subtable");
                                0 === e(r).length && (r = e("<tr/>").addClass("m-datatable__row-subtable m-datatable__row-loading").hide().append(e("<td/>").addClass("m-datatable__subtable").attr("colspan", n.getTotalColumns())),
                                    e(l).after(r),
                                    e(l).hasClass("m-datatable__row--even") && e(r).addClass("m-datatable__row-subtable--even")),
                                    e(r).toggle();
                                ...
                                e(l).hasClass("m-datatable__row--subtable-expanded") ? (e(c).addClass(n.getOption("layout.icons.rowDetail.collapse")),
                                    e(l).removeClass("m-datatable__row--subtable-expanded"),
                                    e(a).trigger("m-datatable--on-collapse-subtable", [l])) : (e(c).addClass(n.getOption("layout.icons.rowDetail.expand")),
                                        e(l).addClass("m-datatable__row--subtable-expanded"),
                                        e(a).trigger("m-datatable--on-expand-subtable", [l])),
                                    0 === e(s).find(".m-datatable").length && (e.map(a.dataSet, function (e, a) {
                                        return d === e[t.columns[0].field] && (i.data = e,
                                            !0)
                                    }),
                                        i.detailCell = s,
                                        i.parentRow = l,
                                        i.subTable = s,
                                        o(i),
                                        e(s).children(".m-datatable").on("m-datatable--on-init", function (t) {
                    ...
                    dataMapCallback: function (e) {
                        var t = e;
                        return "function" == typeof n.getOption("data.source.read.map") ? n.getOption("data.source.read.map")(e) : (void 0 !== e && void 0 !== e.data && (t = e.data),
                            t)
                    },
                    isSpinning: !1,
                    spinnerCallback: function (e) {
                        if (e) {
                            if (!n.isSpinning) {
                                ...
                                !0 === t.message && (t.message = n.getOption("translate.records.processing")),
                                    n.isSpinning = !0,
                                    void 0 !== mApp && mApp.block(a, t)
                            }
                        } else
                            n.isSpinning = !1,
                                void 0 !== mApp && mApp.unblock(a)
                    },
                    ...
                    autoHide: function () {
                        e(a.table).find(".m-datatable__cell").show(),
                            e(a.tableBody).each(function () {
                                for (; e(this)[0].offsetWidth < e(this)[0].scrollWidth;)
                                    e(a.table).find(".m-datatable__row").each(function (t) {
                        ...
                        var o = function (a) {
                            ...
                            var o = e(this).closest(".m-datatable__row")
                                , i = e(o).next();
                            if (e(i).hasClass("m-datatable__row-detail"))
                                e(this).find("i").removeClass(n.getOption("layout.icons.rowDetail.expand")).addClass(n.getOption("layout.icons.rowDetail.collapse")),
                                    e(i).remove();
                            else {
                        ...
                        e(a.tableBody).find(".m-datatable__row").each(function () {
                            e(this).prepend(e("<td/>").addClass("m-datatable__cell m-datatable__toggle--detail").append(e("<a/>").addClass("m-datatable__toggle-detail").attr("href", "#").on("click", o).append(e("<i/>").css("width", "21px").addClass(n.getOption("layout.icons.rowDetail.collapse"))))),
                                0 === e(a.tableHead).find(".m-datatable__toggle-detail").length ? (e(a.tableHead).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>'),
                                    e(a.tableFoot).find(".m-datatable__row").first().prepend('<th class="m-datatable__cell m-datatable__toggle-detail"><span style="width: 21px"></span></th>')) : e(a.tableHead).find(".m-datatable__toggle-detail").find("span").css("width", "21px")
                        })
                    },
                    hoverColumn: function () {
                        e(a.tableBody).on("mouseenter", ".m-datatable__cell", function () {
                            var t = e(n.cell(this).nodes()).index();
                            e(n.cells().nodes()).removeClass("m-datatable__cell--hover"),
                                e(n.column(t).nodes()).addClass("m-datatable__cell--hover")
                        })
                    },
                    setAutoColumns: function () {
                        n.getOption("data.autoColumns") && (e.each(a.dataSet[0], function (a, n) {
                            ...
                            e(a.tableHead).find(".m-datatable__row").remove(),
                            n.setHeadTitle(),
                            n.getOption("layout.footer") && (e(a.tableFoot).find(".m-datatable__row").remove(),
                    ...
                    replaceTableContent: function (t, n) {
                        void 0 === n && (n = a.tableBody),
                            e(n).hasClass("mCustomScrollbar") ? e(n).find(".mCSB_container").html(t) : e(n).html(t)
                    },
                    ...
                    getTableId: function (t) {
                        void 0 === t && (t = "");
                        var n = e(a).attr("id");
                        return void 0 === n && (n = e(a).attr("class").split(" ")[0]),
                            n + t
                    },
                    getTablePrefix: function (e) {
                        return void 0 !== e && (e = "-" + e),
                            n.getTableId() + "-" + n.getDepth() + e
                    },
                    getDepth: function () {
                        var t = 0
                            , n = a.table;
                        do {
                            n = e(n).parents(".m-datatable__table"),
                                t++
                        } while (e(n).length > 0); return t
                    },
                    stateKeep: function (e, t) {
                        e = n.getTablePrefix(e),
                            !1 !== n.getOption("data.saveState") && (n.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(e, JSON.stringify(t)),
                                n.getOption("data.saveState.cookie") && Cookies.set(e, JSON.stringify(t)))
                    },
                    stateGet: function (e, t) {
                        if (e = n.getTablePrefix(e),
                    ...
                    getTotalColumns: function (t) {
                        return void 0 === t && (t = a.tableBody),
                            e(t).find(".m-datatable__row").first().find(".m-datatable__cell").length
                    },
                    ...
                    sortColumn: function (t, n, o) {
                        ...
                        e(l).sort(function (t, a) {
                            ...
                            return o && (l = parseInt(l),
                                r = parseInt(r)),
                                "asc" === n ? l > r ? 1 : l < r ? -1 : 0 : l < r ? 1 : l > r ? -1 : 0
                        }).appendTo(s)
                    },
                    sorting: function () {
                        var o = {
                            init: function () {
                                t.sortable && (e(a.tableHead).find(".m-datatable__cell:not(.m-datatable__cell--check)").addClass("m-datatable__cell--sort").off("click").on("click", o.sortClick),
                                    o.setIcon())
                            },
                            setIcon: function () {
                            ...
                            sortClick: function (i) {
                                ...
                                if ((void 0 === s.sortable || !1 !== s.sortable) && (e(a.tableHead).find(".m-datatable__cell > span > i").remove(),
                                    t.sortable)) {
                                    n.spinnerCallback(!0);
                                    var d = "desc";
                                    n.getObject("field", l) === r && (d = n.getObject("sort", l)),
                                        ...
                                        setTimeout(function () {
                                            n.dataRender("sort"),
                                                e(a).trigger("m-datatable--on-sort", l)
                                        }, 300)
                                }
                            }
                        };
                    ...
                    localDataUpdate: function () {
                        ...
                        if (void 0 !== l && !0 !== n.getOption("data.serverSorting") ? "function" == typeof l.sortCallback ? a.dataSet = l.sortCallback(a.originalDataSet, i, l) : a.dataSet = n.sortCallback(a.originalDataSet, i, l) : a.dataSet = a.originalDataSet,
                            "object" == typeof t.query && !n.getOption("data.serverFiltering")) {
                            t.query = t.query || {};
                            var r = function (e) {
                                for (var t in e)
                                    if (e.hasOwnProperty(t))
                                        if ("string" == typeof e[t]) {
                                            if (e[t].toLowerCase() == s || -1 !== e[t].toLowerCase().indexOf(s))
                                                return !0
                            ...
                            void 0 !== s && "" !== s && (s = s.toLowerCase(),
                                a.dataSet = e.grep(a.dataSet, r),
                                delete t.query[n.getGeneralSearchKey()]),
                                e.each(t.query, function (e, a) {
                                    "" === a && delete t.query[e]
                                }),
                                a.dataSet = n.filterArray(a.dataSet, t.query),
                    ...
                    resetScroll: function () {
                        void 0 === t.detail && 1 === n.getDepth() && (e(a.table).find(".m-datatable__row").css("left", 0),
                            e(a.table).find(".m-datatable__lock").css("top", 0),
                            e(a.tableBody).scrollTop(0))
                    },
                    ...
                    getHiddenDimensions: function (t, a) {
                        ...
                        return i.each(function () {
                            ...
                            o.width = e(t).width(),
                            o.outerWidth = e(t).outerWidth(a),
                            o.innerWidth = e(t).innerWidth(),
                            o.height = e(t).height(),
                            o.innerHeight = e(t).innerHeight(),
                            o.outerHeight = e(t).outerHeight(a),
                            i.each(function (e) {
                                var t = l[e];
                                for (var a in n)
                                    this.style[a] = t[a]
                    ...
                    extendObj: function (e, t, a) {
                        ...
                        return function e(t) {
                            var i = n[o++];
                            void 0 !== t[i] && null !== t[i] ? "object" != typeof t[i] && "function" != typeof t[i] && (t[i] = {}) : t[i] = {},
                                o === n.length ? t[i] = a : e(t[i])
                        }(e),
                            e
                    },
                    timer: 0,
                    redraw: function () {
                        return n.adjustCellsWidth.call(),
                            n.isLocked() && (n.scrollbar(),
                                n.resetScroll(),
                                n.adjustCellsHeight.call()),
                    ...
                    reload: function () {
                        return function (e, t) {
                            clearTimeout(n.timer),
                                n.timer = setTimeout(e, t)
                        }(function () {
                            t.data.serverFiltering || n.localDataUpdate(),
                                n.dataRender(),
                                e(a).trigger("m-datatable--on-reloaded")
                        }, n.getOption("search.delay")),
                            a
                    },
                    getRecord: function (t) {
                        return void 0 === a.tableBody && (a.tableBody = e(a.table).children("tbody")),
                            e(a.tableBody).find(".m-datatable__cell:first-child").each(function (o, i) {
                                if (t == e(i).text()) {
                                    var l = e(i).closest(".m-datatable__row").index() + 1;
                                    return a.API.record = a.API.value = n.getOneRow(a.tableBody, l),
                                        a
                                }
                            }),
                            a
                    ...
                    getColumn: function (t) {
                        return n.setSelectedRecords(),
                            a.API.value = e(a.API.record).find('[data-field="' + t + '"]'),
                            a
                    },
                    destroy: function () {
                        e(a).parent().find(".m-datatable__pager").remove();
                        var t = e(a.initialDatatable).addClass("m-datatable--destroyed").show();
                        return e(a).replaceWith(t),
                            e(a = t).trigger("m-datatable--on-destroy"),
                            n.isInit = !1,
                            t = null
                    },
                    sort: function (t, o) {
                        ...
                        return n.setDataSourceParam("sort", i),
                            setTimeout(function () {
                                n.dataRender("sort"),
                                    e(a).trigger("m-datatable--on-sort", i),
                                    e(a.tableHead).find(".m-datatable__cell > span > i").remove()
                            }, 300),
                            a
                    },
                    getValue: function () {
                    ...
                    setActive: function (t) {
                        "string" == typeof t && (t = e(a.tableBody).find('.m-checkbox--single > [type="checkbox"][value="' + t + '"]')),
                            e(t).prop("checked", !0);
                    ...
                    setSelectedRecords: function () {
                        return a.API.record = e(a.tableBody).find(".m-datatable__row--active"),
                            a
                    },
                    ...
                    setDataSourceParam: function (t, o) {
                        a.API.params = e.extend({}, {
                            ...
                            query: {}
                        }, a.API.params, n.stateGet(n.stateId)),
                            a.API.params = n.extendObj(a.API.params, t, o),
                    ...
                    getDataSourceParam: function (t) {
                        return a.API.params = e.extend({}, {
                            ...
                            "string" == typeof t ? n.getObject(t, a.API.params) : a.API.params
                    },
                    ...
                    showColumn: function (n) {
                        e.map(t.columns, function (e) {
                            return n === e.field && delete e.responsive,
                                e
                        });
                        var o = e.grep(e(a.table).find(".m-datatable__cell"), function (t, a) {
                            return n === e(t).data("field")
                    ...
                    destroyScroller: function (t) {
                        void 0 === t && (t = a.tableBody),
                            e(t).each(function () {
                                if (e(this).hasClass("mCustomScrollbar"))
                                    try {
                    ...
                    row: function (t) {
                        return n.rows(t),
                            n.nodeTr = n.recentNode = e(n.nodeTr).first(),
                            a
                    },
                    rows: function (t) {
                        return n.nodeTr = n.recentNode = e(a.tableBody).find(t).filter(".m-datatable__row"),
                            a
                    },
                    column: function (t) {
                        return n.nodeCols = n.recentNode = e(a.tableBody).find(".m-datatable__cell:nth-child(" + (t + 1) + ")"),
                            a
                    },
                    columns: function (t) {
                        var o = a.table;
                        ...
                        return i.length > 0 ? n.nodeCols = n.recentNode = i : n.nodeCols = n.recentNode = e(o).find(t).filter(".m-datatable__cell"),
                            a
                    },
                    cell: function (t) {
                        return n.cells(t),
                            n.nodeTd = n.recentNode = e(n.nodeTd).first(),
                            a
                    },
                    cells: function (t) {
                        var o = e(a.tableBody).find(".m-datatable__cell");
                        return void 0 !== t && (o = e(o).filter(t)),
                            n.nodeTd = n.recentNode = o,
                            a
                    },
                    remove: function () {
                        return e(n.nodeTr.length) && n.nodeTr === n.recentNode && e(n.nodeTr).remove(),
                            n.layoutUpdate(),
                            a
                    },
                    visible: function (a) {
                        if (e(n.recentNode.length)) {
                            ...
                            a ? (n.recentNode === n.nodeCols && delete t.columns[i].responsive,
                                e(n.recentNode).show()) : (n.recentNode === n.nodeCols && n.setOption("columns." + i + ".responsive", {
                                    hidden: "xl"
                                }),
                                    e(n.recentNode).hide()),
                                n.redraw()
                ...
                if (e.each(n, function (e, t) {
                    ...
                    if ("string" == typeof t) {
                        var o = t;
                        void 0 !== (a = e(this).data("mDatatable")) && (t = a.options,
                            n[o].apply(this, Array.prototype.slice.call(arguments, 1)))
                    } else
                        a.data("mDatatable") || e(this).hasClass("m-datatable--loaded") || (a.dataSet = null,
                            a.textAlign = {
                                left: "m-datatable__cell--left",
                                center: "m-datatable__cell--center",
                                right: "m-datatable__cell--right"
                            },
                            t = e.extend(!0, {}, e.fn.mDatatable.defaults, t),
                            a.options = t,
                            n.init.apply(this, [t]),
                            e(a.wrap).data("mDatatable", a));
                else
                    void 0 === (a = e(this).data("mDatatable")) && e.error("mDatatable not initialized"),
                        t = a.options;
                return a
            }
        ...
        var i = {
            ...
            , l = {
                construct: function (e) {
                    return mUtil.data(n).has("dropdown") ? a = mUtil.data(n).get("dropdown") : (l.init(e),
                        l.setup(),
                        mUtil.data(n).set("dropdown", a)),
                        a
                },
                init: function (e) {
                    a.options = mUtil.deepExtend({}, i, e),
                        a.events = [],
                        a.eventHandlers = {},
                        a.open = !1,
                        a.layout = {},
                ...
                show: function () {
                    ...
                    if (a.layout.arrow && l.adjustArrowPos(),
                        ...
                        mUtil.addClass(t, "m-dropdown__dropoff"),
                            mUtil.css(t, "z-index", e),
                            mUtil.data(t).set("dropdown", n),
                            mUtil.data(n).set("dropoff", t),
                            mUtil.addEvent(t, "click", function (e) {
                                l.hide(),
                                    mUtil.remove(this),
                                    e.preventDefault()
                            })
                ...
                hide: function (e) {
                    return !1 === a.open ? a : (mUtil.isDesktopDevice() && "hover" == a.options.toggle ? l.hideHovered(e) : l.hideClicked(),
                ...
                adjustArrowPos: function () {
                    var e = mUtil.outerWidth(n)
                        ...
                        , o = 0;
                    a.layout.arrow && (mUtil.isInResponsiveRange("mobile") && mUtil.hasClass(n, "m-dropdown--mobile-full-width") ? (o = mUtil.offset(n).left + e / 2 - Math.abs(parseInt(mUtil.css(a.layout.arrow, "width")) / 2) - parseInt(mUtil.css(a.layout.wrapper, "left")),
                        mUtil.css(a.layout.arrow, "right", "auto"),
                        mUtil.css(a.layout.arrow, "left", o + "px"),
                        mUtil.css(a.layout.arrow, "margin-left", "auto"),
                        mUtil.css(a.layout.arrow, "margin-right", "auto")) : mUtil.hasClass(a.layout.arrow, "m-dropdown__arrow--adjust") && (o = e / 2 - Math.abs(parseInt(mUtil.css(a.layout.arrow, "width")) / 2),
                            mUtil.hasClass(n, "m-dropdown--align-push") && (o += 20),
                            "right" == t ? (mUtil.css(a.layout.arrow, "left", "auto"),
                ...
                setZindex: function () {
                    ...
                    t >= e && (e = t + 1),
                        mUtil.css(a.layout.wrapper, "z-index", e)
                },
                ...
                eventTrigger: function (e, t) {
                    for (var n = 0; n < a.events.length; n++) {
                        var o = a.events[n];
                        o.name == e && (1 == o.one ? 0 == o.fired && (a.events[n].fired = !0,
                            o.handler.call(this, a, t)) : o.handler.call(this, a, t))
                    }
                },
...
mUtil.on(document, '[m-dropdown-toggle="click"] .m-dropdown__toggle', "click", function (e) {
    ...
    t && ((mUtil.data(t).has("dropdown") ? mUtil.data(t).get("dropdown") : new mDropdown(t)).toggle(),
        e.preventDefault())
}),
    mUtil.on(document, '[m-dropdown-toggle="hover"] .m-dropdown__toggle', "click", function (e) {
        if (mUtil.isDesktopDevice())
            "#" == mUtil.attr(this, "href") && e.preventDefault();
    ...
    document.addEventListener("click", function (e) {
        ...
        if (t = a.querySelectorAll(".m-dropdown.m-dropdown--open"))
            for (var o = 0, i = t.length; o < i; o++) {
                ...
                mUtil.hasClass(l, "m-dropdown--disable-close") && (e.preventDefault(),
                    e.stopPropagation()),
                    s && n !== s && !1 === s.contains(n) && !1 === n.contains(s) ? !0 === r.isPersistent() ? !1 === l.contains(n) && r.hide() : r.hide() : !1 === l.contains(n) && r.hide()
            }
    });
var mHeader = function (e, t) {
    ...
    if (void 0 !== n) {
        var i = {
            ...
            , l = {
                construct: function (e) {
                    return mUtil.data(n).has("header") ? a = mUtil.data(n).get("header") : (l.init(e),
                        l.build(),
                ...
                build: function () {
                    ...
                    !1 === a.options.minimize.mobile && !1 === a.options.minimize.desktop || window.addEventListener("scroll", function () {
                        ...
                        mUtil.isInResponsiveRange("desktop") ? (l = a.options.offset.desktop,
                            t = a.options.minimize.desktop.on,
                            n = a.options.minimize.desktop.off) : mUtil.isInResponsiveRange("tablet-and-mobile") && (l = a.options.offset.mobile,
                                t = a.options.minimize.mobile.on,
                                n = a.options.minimize.mobile.off),
                            i = window.pageYOffset,
                            mUtil.isInResponsiveRange("tablet-and-mobile") && a.options.classic && a.options.classic.mobile || mUtil.isInResponsiveRange("desktop") && a.options.classic && a.options.classic.desktop ? i > l ? (mUtil.addClass(o, t),
                                mUtil.removeClass(o, n)) : (mUtil.addClass(o, n),
                                    mUtil.removeClass(o, t)) : (i > l && e < i ? (mUtil.addClass(o, t),
                                        mUtil.removeClass(o, n)) : (mUtil.addClass(o, n),
                                            mUtil.removeClass(o, t)),
                                        e = i)
                    })
                },
                eventTrigger: function (e, t) {
    ...
    , mMenu = function (e, t) {
        ...
        if (o) {
            var l = {
                ...
                , r = {
                    construct: function (e) {
                        return mUtil.data(o).has("menu") ? a = mUtil.data(o).get("menu") : (r.init(e),
                            r.reset(),
                            r.build(),
                    ...
                    init: function (e) {
                        a.events = [],
                            a.eventHandlers = {},
                            a.options = mUtil.deepExtend({}, l, e),
                    ...
                    handleLinkClick: function (e) {
                        !1 === r.eventTrigger("linkClick", this) && e.preventDefault(),
                            ("dropdown" === r.getSubmenuMode(this) || r.isConditionalSubmenuDropdown()) && r.handleSubmenuDropdownClose(e, this)
                    },
                    ...
                    handleSubmenuDrodownHoverExit: function (e) {
                        if (!1 !== a.resumeDropdownHover() && "accordion" !== r.getSubmenuMode(this)) {
                            ...
                            t.setAttribute("data-hover", "1"),
                                t.setAttribute("data-timeout", o)
                        }
                    },
                    handleSubmenuDropdownClick: function (e) {
                        if ("accordion" !== r.getSubmenuMode(this)) {
                            var t = this.closest(".m-menu__item");
                            "accordion" != t.getAttribute("m-menu-submenu-mode") && (!1 === mUtil.hasClass(t, "m-menu__item--hover") ? (mUtil.addClass(t, "m-menu__item--open-dropdown"),
                                r.showSubmenuDropdown(t)) : (mUtil.removeClass(t, "m-menu__item--open-dropdown"),
                    ...
                    handleSubmenuDropdownTabClick: function (e) {
                        if ("accordion" !== r.getSubmenuMode(this)) {
                            var t = this.closest(".m-menu__item");
                            "accordion" != t.getAttribute("m-menu-submenu-mode") && (0 == mUtil.hasClass(t, "m-menu__item--hover") && (mUtil.addClass(t, "m-menu__item--open-dropdown"),
                                r.showSubmenuDropdown(t)),
                                e.preventDefault())
                        }
                    },
                    ...
                    handleSubmenuAccordion: function (e, t) {
                        var n, o = t || this;
                        if ("dropdown" === r.getSubmenuMode(t) && (n = o.closest(".m-menu__item")) && "accordion" != n.getAttribute("m-menu-submenu-mode"))
                            e.preventDefault();
                        else {
                    ...
                    hideSubmenuDropdown: function (e, t) {
                        t && (mUtil.removeClass(e, "m-menu__item--hover"),
                            mUtil.removeClass(e, "m-menu__item--active-tab")),
                            e.removeAttribute("data-hover"),
                            e.getAttribute("m-menu-dropdown-toggle-class") && mUtil.removeClass(i, e.getAttribute("m-menu-dropdown-toggle-class"));
                    ...
                    showSubmenuDropdown: function (e) {
                        ...
                        r.adjustSubmenuDropdownArrowPos(e),
                            mUtil.addClass(e, "m-menu__item--hover"),
                            e.getAttribute("m-menu-dropdown-toggle-class") && mUtil.addClass(i, e.getAttribute("m-menu-dropdown-toggle-class"))
                    },
                    createSubmenuDropdownClickDropoff: function (e) {
                        var t, a = (t = mUtil.child(e, ".m-menu__submenu") ? mUtil.css(t, "z-index") : 0) - 1, n = document.createElement('<div class="m-menu__dropoff" style="background: transparent; position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: ' + a + '"></div>');
                        i.appendChild(n),
                    ...
                    adjustSubmenuDropdownArrowPos: function (e) {
                        ...
                        if (a) {
                            ...
                            mUtil.hasClass(t, "m-menu__submenu--classic") || mUtil.hasClass(t, "m-menu__submenu--fixed") ? mUtil.hasClass(t, "m-menu__submenu--right") ? (n = mUtil.outerWidth(e) / 2,
                                mUtil.hasClass(t, "m-menu__submenu--pull") && (n += Math.abs(parseFloat(mUtil.css(t, "margin-right")))),
                                n = parseInt(mUtil.css(t, "width")) - n) : mUtil.hasClass(t, "m-menu__submenu--left") && (n = mUtil.outerWidth(e) / 2,
                                    mUtil.hasClass(t, "m-menu__submenu--pull") && (n += Math.abs(parseFloat(mUtil.css(t, "margin-left"))))) : (mUtil.hasClass(t, "m-menu__submenu--center") || mUtil.hasClass(t, "m-menu__submenu--full")) && (n = mUtil.offset(e).left - (mUtil.getViewPort().width - parseInt(mUtil.css(t, "width"))) / 2,
                                        n += mUtil.outerWidth(e) / 2),
                    ...
                    setActiveItem: function (e) {
                        r.resetActiveItem(),
                            mUtil.addClass(e, "m-menu__item--active");
                        for (var t = mUtil.parents(e, ".m-menu__item--submenu"), a = 0, n = t.length; a < n; a++)
                            mUtil.addClass(t[a], "m-menu__item--open")
                    },
...
var mOffcanvas = function (e, t) {
    ...
    if (n) {
        var i = {}
            , l = {
                construct: function (e) {
                    return mUtil.data(n).has("offcanvas") ? a = mUtil.data(n).get("offcanvas") : (l.init(e),
                        l.build(),
                    ...
                    if (a.options.toggleBy)
                        if ("string" == typeof a.options.toggleBy)
                            ...
                            for (var e in a.options.toggleBy)
                                mUtil.addEvent(a.options.toggleBy[e].target, "click", l.toggle);
                        else
                ...
                show: function (e) {
                    "shown" != a.state && (l.eventTrigger("beforeShow"),
                        ...
                        a.options.overlay && (a.overlay = mUtil.insertAfter(document.createElement("DIV"), n),
                            ...
                            mUtil.addEvent(a.overlay, "click", function (t) {
                                t.stopPropagation(),
                                    t.preventDefault(),
                                    l.hide(e)
                            })),
                ...
                togglerClass: function (e, t) {
                    ...
                    if (n) {
                        ...
                        "show" === t && mUtil.addClass(l, n.state),
                            "hide" === t && mUtil.removeClass(l, n.state)
                    }
                },
                eventTrigger: function (e, t) {
                    for (var n = 0; n < a.events.length; n++) {
    ...
    , mPortlet = function (e, t) {
        ...
        if (n) {
            var l = {
                ...
                , r = {
                    construct: function (e) {
                        return mUtil.data(n).has("portlet") ? a = mUtil.data(n).get("portlet") : (r.init(e),
                            r.build(),
                    ...
                    fullscreen: function (e) {
                        if ("off" === e || mUtil.hasClass(o, "m-portlet--fullscreen") && mUtil.hasClass(n, "m-portlet--fullscreen"))
                            ...
                            if (r.eventTrigger("beforeFullscreenOn"),
                                ...
                                mUtil.css(a.body, "margin-bottom", t + "px"),
                    ...
                    eventTrigger: function (e) {
                        for (i = 0; i < a.events.length; i++) {
                            var t = a.events[i];
                            t.name == e && (1 == t.one ? 0 == t.fired && (a.events[i].fired = !0,
                                t.handler.call(this, a)) : t.handler.call(this, a))
                        }
                    },
                    addEvent: function (e, t, n) {
    ...
    , mQuicksearch = function (e, t) {
        ...
        if (n) {
            var l = {
                ...
                , r = {
                    construct: function (e) {
                        return mUtil.data(n).has("quicksearch") ? a = mUtil.data(n).get("quicksearch") : (r.init(e),
                            r.build(),
                    ...
                    handleCancelIconVisibility: function (e) {
                        "on" == e ? 0 === a.input.value.length ? (a.iconCancel && mUtil.css(a.iconCancel, "visibility", "hidden"),
    ...
    , mScrollTop = function (e, t) {
        ...
        if (n) {
            var i = {
                ...
                , l = {
                    construct: function (e) {
                        return mUtil.data(n).has("scrolltop") ? a = mUtil.data(n).get("scrolltop") : (l.init(e),
                            l.build(),
                    ...
                    scroll: function (e) {
                        e.preventDefault(),
                            mUtil.scrollTop(a.options.speed)
                    },
                    eventTrigger: function (e, t) {
                        for (var n = 0; n < a.events.length; n++) {
                            var o = a.events[n];
    ...
    , mToggle = function (e, t) {
        ...
        if (n) {
            var o = {
                ...
                , l = {
                    construct: function (e) {
                        return mUtil.data(n).has("toggle") ? a = mUtil.data(n).get("toggle") : (l.init(e),
                            l.build(),
                    ...
                    init: function (e) {
                        a.element = n,
                            a.events = [],
                            a.options = mUtil.deepExtend({}, o, e),
                    ...
                    toggle: function () {
                        return "off" == a.state ? l.toggleOn() : l.toggleOff(),
                            a
                    },
                    toggleOn: function () {
    ...
    , mWizard = function (e, t) {
        ...
        if (n) {
            var o = {
                ...
                , l = {
                    construct: function (e) {
                        return mUtil.data(n).has("wizard") ? a = mUtil.data(n).get("wizard") : (l.init(e),
                            l.build(),
                    ...
                    goTo: function (e) {
                        if (e !== a.currentStep) {
                            var t;
                            if (t = (e = e ? parseInt(e) : l.getNextStep()) > a.currentStep ? l.eventTrigger("beforeNext") : l.eventTrigger("beforePrev"),
                                !0 !== a.stop)
                                return !1 !== t && (a.currentStep = e,
                                    l.updateUI(),
                                    l.eventTrigger("change")),
                                    e > a.startStep ? l.eventTrigger("afterNext") : l.eventTrigger("afterPrev"),
                                    a;
                            a.stop = !1
                        }
                    },
                    ...
                    updateUI: function (e) {
                        l.updateProgress(),
                            l.handleTarget(),
                            l.setStepClass();
                        for (var t = 0, n = a.steps.length; t < n; t++)
                            mUtil.removeClass(a.steps[t], "m-wizard__step--current m-wizard__step--done");
                        for (t = 1; t < a.currentStep; t++)
                            mUtil.addClass(a.steps[t - 1], "m-wizard__step--done");
                    ...
                    handleTarget: function () {
                        ...
                        mUtil.removeClass(o, "m-wizard__form-step--current"),
                            mUtil.addClass(t, "m-wizard__form-step--current")
                    },
...
!function (e) {
    e.fn.mDatatable = e.fn.mDatatable || {},
        e.fn.mDatatable.checkbox = function (t, a) {
            var n = {
                selectedAllRows: !1,
                selectedRows: [],
                unselectedRows: [],
                init: function () {
                    n.selectorEnabled() && (a.vars.requestIds && t.setDataSourceParam(a.vars.requestIds, !0),
                        n.selectedAllRows = t.getDataSourceParam(a.vars.selectedAllRows),
                        e(t).on("m-datatable--on-layout-updated", function (a, o) {
                ...
                initEvent: function () {
                    e(t.tableHead).find('.m-checkbox--all > [type="checkbox"]').click(function (o) {
                        if (n.selectedRows = n.unselectedRows = [],
                            t.stateRemove("checkbox"),
                            e(this).is(":checked") ? n.selectedAllRows = !0 : n.selectedAllRows = !1,
                            !a.vars.requestIds) {
                            e(this).is(":checked") && (n.selectedRows = e.makeArray(e(t.tableBody).find('.m-checkbox--single > [type="checkbox"]').map(function (t, a) {
                                return e(a).val()
                            })));
                            var i = {};
                            i.selectedRows = e.unique(n.selectedRows),
                                t.stateKeep("checkbox", i)
                        }
                        t.setDataSourceParam(a.vars.selectedAllRows, n.selectedAllRows),
                            e(t).trigger("m-datatable--on-click-checkbox", [e(this)])
                    }),
                        e(t.tableBody).find('.m-checkbox--single > [type="checkbox"]').click(function (o) {
                            var i = e(this).val();
                            e(this).is(":checked") ? (n.selectedRows.push(i),
                                n.unselectedRows = n.remove(n.unselectedRows, i)) : (n.unselectedRows.push(i),
                                    n.selectedRows = n.remove(n.selectedRows, i)),
                                !a.vars.requestIds && n.selectedRows.length < 1 && e(t.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop("checked", !1);
                            var l = {};
                            l.selectedRows = e.unique(n.selectedRows),
                                l.unselectedRows = e.unique(n.unselectedRows),
                                t.stateKeep("checkbox", l),
                                e(t).trigger("m-datatable--on-click-checkbox", [e(this)])
                        })
                },
                initSelect: function () {
                    n.selectedAllRows && a.vars.requestIds ? (t.hasClass("m-datatable--error") || e(t.tableHead).find('.m-checkbox--all > [type="checkbox"]').prop("checked", !0),
                        t.setActiveAll(!0),
                        n.unselectedRows.forEach(function (e) {
                            t.setInactive(e)
                ...
                initVars: function () {
                    ...
                    void 0 !== e && (n.selectedRows = e.selectedRows || [],
                        n.unselectedRows = e.unselectedRows || [])
                },
            ...
            return t.checkbox = function () {
                ...
                ,
                "object" == typeof a && (a = e.extend(!0, {}, e.fn.mDatatable.checkbox.default, a),
                    n.init.apply(this, [a])),
                t
        }
        ,
    ...
    return {
        ...
        initHeader: function () {
            ...
            a = mUtil.get("m_header"),
                ...
                "minimize" == mUtil.attr(a, "m-minimize-mobile") ? (o.minimize.mobile = {},
                    o.minimize.mobile.on = "m-header--minimize-on",
                    o.minimize.mobile.off = "m-header--minimize-off") : o.minimize.mobile = !1,
                "minimize" == mUtil.attr(a, "m-minimize") ? (o.minimize.desktop = {},
                    o.minimize.desktop.on = "m-header--minimize-on",
                    o.minimize.desktop.off = "m-header--minimize-off") : o.minimize.desktop = !1,
                (t = mUtil.attr(a, "m-minimize-offset")) && (o.offset.desktop = t),
                (t = mUtil.attr(a, "m-minimize-mobile-offset")) && (o.offset.mobile = t),
                header = new mHeader("m_header", o),
                    ...
                    quicksearch.on("search", function (e) {
                        e.showProgress(),
                            $.ajax({
                                ...
                                error: function (t) {
                                    e.hideProgress(),
                                        e.showError("Connection error. Pleae try again later.")
                                }
                            })
                    })),
        ...
        initAside: function () {
            var n, o;
            n = mUtil.get("m_aside_left"),
                o = mUtil.hasClass(n, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left",
